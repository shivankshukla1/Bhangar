...
export const UserDetails = () => {
  ...
  const edit = (product_id) => () =>{
    ...
    return(
          ...
          <li>
              ...
              <div id="dropdownNavbar" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                  <ul class="py-2 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                      <li>
                          <a href="/SportsEquipment" class="block px-4 text-left py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Sports Equipment</a>
                      </li>
                      <li>
                          <a href="/Electronic_devices" class="block px-4 text-left py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Electronic Devices</a>
                      </li>
                      <li>
                          <a href="/StationaryAndBooks" class="block px-4 text-left py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Stationary & Books</a>
                      </li>
                      <li>
                      <a href="/Cycle" class="block px-4 text-left py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Cycle</a>
                      </li>
                      <li>
                      <a href="/Cooler" class="block px-4 text-left py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Cooler</a>
                      </li>
      ...
      <div class=" pt-28 container mx-auto p-6 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-screen-xl items-center justify-between mx-auto p-4">
      {

          products && products.map((product) => (
          <div>
          <div class="col-span-1 flex flex-col bg-purple-300 border-2 border-purple-300 text-left">
