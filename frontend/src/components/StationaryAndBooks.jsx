...
export const StationaryAndBooks = () => {
    ...
    return (
        ...
        <div class="min-h-screen container mx-auto grid grid-cols-2 md:grid-cols-4 gap-4 max-w-screen-xl items-center justify-between mx-auto">
        {
